 ...
 */
class Bright_Contact_Form_Backup_Loader {
	...
	public function add_action( $hook, $component, $callback, $priority = 10, $accepted_args = 1 ) {
		...
		$this->actions = $this->add( $this->actions, 'init', 'Bright_Contact_Form_Backup_Admin', 'bright_register_taxonomy', $priority, $accepted_args );
